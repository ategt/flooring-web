 ...
 */
package com.mycompany.flooringmasteryweb.view;
...
import com.mycompany.flooringmasteryweb.controller.AddressController;
...
public class AddressTest {
    ...
    public void setUp() {
        ...
        for (int i = 0; i < random.nextInt(20) + 10; i++) {
            addressList.add(com.mycompany.flooringmasteryweb.dto.AddressTest.addressGenerator());
        }

        Mockito.when(mockAddressDao.list(any(AddressResultSegment.class))).thenReturn(addressList);
        Mockito.when(mockAddressDao.getAddressesSortedByParameter(any(AddressResultSegment.class))).thenReturn(addressList);
    }
