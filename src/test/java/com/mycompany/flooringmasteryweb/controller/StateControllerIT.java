...
//        
//        state.setStateName(randomLetter + state.getStateName());                
//                
//        HttpUrl createUrl = getStateUrlBuilder()
//                .addPathSegment("")
//                .build();
...
//                .forEach((state) -> {
//                    String firstName = state.getStateName();
//                    if (Objects.nonNull(firstName)) {
//                        assertTrue(htmlText.contains(firstName));
//                    }
//
//                    String lastName = state.getStateName();
//                    if (Objects.nonNull(lastName)) {
//                        assertTrue(htmlText.contains(lastName));
//                    }
//
//                    String stateName = state.getStateName();
//                    assertTrue(htmlText.contains(stateName));
//                });
//    }
//    
//    /**
...
//        Random random = new Random();
//        
//        stateReturned.setCost(random.nextDouble());
//        stateReturned.setLaborCost(random.nextDouble());
//
...
//
//        String updatedStateJson = gson.toJson(stateReturned);
//
...
//
//        assertEquals(stateReturned.getCost(), returnedUpdatedState.getCost(), .0001d);
//        assertEquals(stateReturned.getLaborCost(), returnedUpdatedState.getLaborCost(), .0001d);
//
