...
public class AddressDaoPostgresImplTest {
    ...
    public void getSortedByFirstName() {
        ...
        addresses.sort((Object o1, Object o2) -> {
            ...
            if (Strings.isNullOrEmpty(address1.getFirstName())
                    && Strings.isNullOrEmpty(address1.getFirstName())) {

                if (address1.getFirstName() == null && address2.getFirstName() == null) {
                    result = 0;
                } else if (address1.getFirstName() == null) {
                    result = -1;
                ...
                } else if (address1.getFirstName().isEmpty()) {
                } else if (address1.getFirstName() == null) {
                    if (address1.getFirstName() == null) {

                    }

                    String firstName1 = Strings.nullToEmpty(address1.getFirstName()).toLowerCase();
                    String firstName2 = Strings.nullToEmpty(address2.getFirstName()).toLowerCase();
        ...
        List<Address> addresses = addressDao.list();
                ...
                addresses.sort((Object o1, Object o2) -> {
                    ...
                    return address1.getCompany().compareTo(address2.getCompany());
                });
